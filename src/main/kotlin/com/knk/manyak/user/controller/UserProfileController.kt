...
class UserProfileController(
    ...
    @Operation(
        ...
        description = "닉네임과 프로필 이미지를 바꿉니다(KNK-1147). **보낸 필드만 반영**하며 둘 다 없으면 400입니다. " +
            "닉네임은 입력값 그대로 2~20자이고 한글·영문·숫자만 쓸 수 있습니다(공백·자모 단독·" +
            "특수문자·이모지는 400). 유일성은 대소문자와 공백을 무시한 정규화 기준이라 `StoryTeller`와 " +
            "`storyteller`는 같은 닉네임으로 보고 409입니다. 다만 자기 닉네임의 대소문자만 바꾸는 것은 " +
