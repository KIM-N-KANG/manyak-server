...
class SecurityConfig {
        ...
        http
            ...
            .authorizeHttpRequests {
                ...
                it
                    ...
                    // 백그라운드 생성 복구 조회(§4-3-8). 인증 선택(회원 userId 귀속·게스트 device). 소유 게이트(404)는 서비스가 처리한다.
                    .requestMatchers(PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.GET, "/api/v1/stories/simple/creation-requests/{requestId}")).permitAll()
                    ...
                    .requestMatchers(PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.GET, "/api/v1/users/me/trials")).permitAll()
    ...
    private companion object {
        ...
        val OPTIONAL_AUTH_MATCHERS = arrayOf(
            ...
            PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.GET, "/api/v1/users/me/trials"),
