...
class StorySubmissionController(private val service: StorySubmissionService) {
    ...
    fun resubmit(@PathVariable id: String, @CurrentUserId userId: Long?, @Valid @RequestBody request: CreateGeneralStoryRequest) = service.resubmit(id, request, member(userId))
